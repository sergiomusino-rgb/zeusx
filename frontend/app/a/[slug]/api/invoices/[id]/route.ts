...
// Dati di esempio per le fatture
const mockFatture: any[] = [
  {
    id: '1',
    tenant_id: 'tenant-1',
    numero_fattura: '001',
  ...
  },
  {
    ...
    numero_fattura: '004',
    anno: 2026,
    data_emissione: '2026-07-04',
    cliente_nome: 'Cliente Test',
    cliente_piva: 'IT99999999999',
    cliente_indirizzo: 'Via Test 4, Milano',
    stato: 'emessa',
    metodo_pagamento: 'bonifico',
...
const mockRighe: Record<string, any[]> = {
  ...
  '4': [
    { id: '5', fattura_id: '4', descrizione: 'Prodotto D', quantita: 2, prezzo_unitario: 25, aliquota_iva: 22 },
  ],
};
...
export async function GET(
  ...
  try {
    ...
    const fattura = mockFatture.find((f: any) => f.id === fatturaId);
