-- Script minimale per creare SOLO app_records e le sue policy
-- Copia questo nel SQL Editor di Supabase ed esegui

-- Step 1: Pulizia aggressiva di app_records
...
-- Step 2: Ricrea app_records con la struttura corretta
...
-- Verifica finale
SELECT column_name, data_type FROM information_schema.columns WHERE table_name = 'app_records' ORDER BY ordinal_position;
SELECT count(*) AS policy_count FROM pg_policies WHERE schemaname = 'public' AND tablename = 'app_records';